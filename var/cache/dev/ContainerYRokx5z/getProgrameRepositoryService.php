 ...
 */
class getProgrameRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProgrameRepository' shared autowired service.
     *
     * @return \App\Repository\ProgrameRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProgrameRepository.php';

        return $container->privates['App\\Repository\\ProgrameRepository'] = new \App\Repository\ProgrameRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
