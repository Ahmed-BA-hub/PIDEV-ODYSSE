 ...
 */
class getCivilisationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CivilisationRepository' shared autowired service.
     *
     * @return \App\Repository\CivilisationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CivilisationRepository.php';

        return $container->privates['App\\Repository\\CivilisationRepository'] = new \App\Repository\CivilisationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
