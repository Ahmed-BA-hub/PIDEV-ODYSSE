 ...
 */
class getResrvationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ResrvationRepository' shared autowired service.
     *
     * @return \App\Repository\ResrvationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ResrvationRepository.php';

        return $container->privates['App\\Repository\\ResrvationRepository'] = new \App\Repository\ResrvationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
