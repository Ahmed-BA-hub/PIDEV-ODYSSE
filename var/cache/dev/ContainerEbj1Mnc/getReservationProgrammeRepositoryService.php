 ...
 */
class getReservationProgrammeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReservationProgrammeRepository' shared autowired service.
     *
     * @return \App\Repository\ReservationProgrammeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReservationProgrammeRepository.php';

        return $container->privates['App\\Repository\\ReservationProgrammeRepository'] = new \App\Repository\ReservationProgrammeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
