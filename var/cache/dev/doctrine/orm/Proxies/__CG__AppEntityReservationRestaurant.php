 ...
 */
class ReservationRestaurant extends \App\Entity\ReservationRestaurant implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'restaurant' => [parent::class, 'restaurant', null],
        ...
        'restaurant' => [parent::class, 'restaurant', null],
