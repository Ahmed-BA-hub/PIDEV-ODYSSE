 ...
 */
class getBlogCommentRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BlogCommentRepository.php';

        return $container->privates['App\\Repository\\BlogCommentRepository'] = new \App\Repository\BlogCommentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
