...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\CivilisationController' => 'getCivilisationControllerService',
            'App\\Controller\\DashboardController' => 'getDashboardControllerService',
            'App\\Controller\\FindGuideController' => 'getFindGuideControllerService',
            'App\\Controller\\GuidedetailsController' => 'getGuidedetailsControllerService',
            ...
            'App\\Controller\\ProgrameController' => 'getProgrameControllerService',
            ...
            'App\\Controller\\ReservationProgrammeController' => 'getReservationProgrammeControllerService',
            'App\\Controller\\ReservationRestaurantController' => 'getReservationRestaurantControllerService',
            ...
            'Vich\\UploaderBundle\\Naming\\HashNamer.civilisation_images' => 'getHashNamer_CivilisationImagesService',
            'Vich\\UploaderBundle\\Naming\\HashNamer.programe_images' => 'getHashNamer_ProgrameImagesService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('l1GBQX7sjN', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PbqFM3ZmVc', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OHSTq8tPmY', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eG-NJQ6eaG', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\BlogArticleRepository' => ['privates', 'App\\Repository\\BlogArticleRepository', 'getBlogArticleRepositoryService', true],
            'App\\Repository\\BlogCommentRepository' => ['privates', 'App\\Repository\\BlogCommentRepository', 'getBlogCommentRepositoryService', true],
            'App\\Repository\\CivilisationRepository' => ['privates', 'App\\Repository\\CivilisationRepository', 'getCivilisationRepositoryService', true],
            ...
            'App\\Repository\\ProgrameRepository' => ['privates', 'App\\Repository\\ProgrameRepository', 'getProgrameRepositoryService', true],
            'App\\Repository\\ReclamationRepository' => ['privates', 'App\\Repository\\ReclamationRepository', 'getReclamationRepositoryService', true],
            'App\\Repository\\ReservationHotelRepository' => ['privates', 'App\\Repository\\ReservationHotelRepository', 'getReservationHotelRepositoryService', true],
            'App\\Repository\\ReservationProgrammeRepository' => ['privates', 'App\\Repository\\ReservationProgrammeRepository', 'getReservationProgrammeRepositoryService', true],
            'App\\Repository\\ReservationRestaurantRepository' => ['privates', 'App\\Repository\\ReservationRestaurantRepository', 'getReservationRestaurantRepositoryService', true],
            'App\\Repository\\ResrvationRepository' => ['privates', 'App\\Repository\\ResrvationRepository', 'getResrvationRepositoryService', true],
            ...
            'App\\Repository\\BlogArticleRepository' => '?',
            'App\\Repository\\BlogCommentRepository' => '?',
            'App\\Repository\\CivilisationRepository' => '?',
            ...
            'App\\Repository\\ProgrameRepository' => '?',
            'App\\Repository\\ReclamationRepository' => '?',
            'App\\Repository\\ReservationHotelRepository' => '?',
            'App\\Repository\\ReservationProgrammeRepository' => '?',
            'App\\Repository\\ReservationRestaurantRepository' => '?',
            'App\\Repository\\ResrvationRepository' => '?',
        ...
        $instance = ($lazyLoad->__construct(($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'vich_uploader.listener.clean.civilisation_images' => ['privates', 'vich_uploader.listener.clean.civilisation_images', 'getVichUploader_Listener_Clean_CivilisationImagesService', true],
            'vich_uploader.listener.clean.programe_images' => ['privates', 'vich_uploader.listener.clean.programe_images', 'getVichUploader_Listener_Clean_ProgrameImagesService', true],
            'vich_uploader.listener.remove.civilisation_images' => ['privates', 'vich_uploader.listener.remove.civilisation_images', 'getVichUploader_Listener_Remove_CivilisationImagesService', true],
            'vich_uploader.listener.remove.programe_images' => ['privates', 'vich_uploader.listener.remove.programe_images', 'getVichUploader_Listener_Remove_ProgrameImagesService', true],
            'vich_uploader.listener.upload.civilisation_images' => ['privates', 'vich_uploader.listener.upload.civilisation_images', 'getVichUploader_Listener_Upload_CivilisationImagesService', true],
            'vich_uploader.listener.upload.programe_images' => ['privates', 'vich_uploader.listener.upload.programe_images', 'getVichUploader_Listener_Upload_ProgrameImagesService', true],
        ], [
            ...
            'vich_uploader.listener.clean.civilisation_images' => '?',
            'vich_uploader.listener.clean.programe_images' => '?',
            'vich_uploader.listener.remove.civilisation_images' => '?',
            'vich_uploader.listener.remove.programe_images' => '?',
            'vich_uploader.listener.upload.civilisation_images' => '?',
            'vich_uploader.listener.upload.programe_images' => '?',
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.civilisation_images'], [['preUpdate'], 'vich_uploader.listener.clean.programe_images'], [['postGenerateSchema'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['onSchemaCreateTable'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['onFlush'], 'turbo.doctrine.event_listener'], [['postFlush'], 'turbo.doctrine.event_listener'], [['preRemove'], 'vich_uploader.listener.remove.civilisation_images'], [['postFlush'], 'vich_uploader.listener.remove.civilisation_images'], [['prePersist'], 'vich_uploader.listener.upload.civilisation_images'], [['preUpdate'], 'vich_uploader.listener.upload.civilisation_images'], [['preRemove'], 'vich_uploader.listener.remove.programe_images'], [['postFlush'], 'vich_uploader.listener.remove.programe_images'], [['prePersist'], 'vich_uploader.listener.upload.programe_images'], [['preUpdate'], 'vich_uploader.listener.upload.programe_images']])) && false ?: $lazyLoad);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\CivilisationController', 'App\\Controller\\DashboardController', 'App\\Controller\\FindGuideController', 'App\\Controller\\GuidedetailsController', 'App\\Controller\\HomePageController', 'App\\Controller\\HotelController', 'App\\Controller\\LoginController', 'App\\Controller\\ProgrameController', 'App\\Controller\\ReclamationController', 'App\\Controller\\ReservationHotelController', 'App\\Controller\\ReservationProgrammeController', 'App\\Controller\\ReservationRestaurantController', 'App\\Controller\\RestaurantController', 'App\\Controller\\SignUpController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NaWY8AaSmo', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('p8nIZWhKmK', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('a4q1Y0liH7', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rpZqZ2+Pcj', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5Y5b3CcDgY', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MzyC5fetFW', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PxTcWJfQfg', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'vich_uploader.mappings' => [
                'civilisation_images' => [
                    'uri_prefix' => '/images/civilisations',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/civilisations'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\HashNamer.civilisation_images',
                        'options' => [
                ...
                'programe_images' => [
                    'uri_prefix' => '/images/programes',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/programes'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\HashNamer.programe_images',
                        'options' => [
