 ...
 */
class getBlogArticleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BlogArticleRepository' shared autowired service.
     *
     * @return \App\Repository\BlogArticleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BlogArticleRepository.php';

        return $container->privates['App\\Repository\\BlogArticleRepository'] = new \App\Repository\BlogArticleRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
