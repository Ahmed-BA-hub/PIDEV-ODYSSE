...
/* back.html.twig */
class __TwigTemplate_cf8d67122b5ae424bcc9290a4624faac extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
        ...
        echo "\"><i class=\"fa fa-circle-o-notch\" aria-hidden=\"true\"></i>Manage Civilisations</a>
\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
        // line 188
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("app_programe_index_back");
        echo "\"><i class=\"fa fa-circle-o-notch\" aria-hidden=\"true\"></i>Manage programes</a>
\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t   <li>
...
\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t<a href=\"javascript:void(0)\"><i class=\"ti-calendar\" aria-hidden=\"true\"></i>Les Reservations <span class=\"fa arrow\"></span></a>
\t\t\t\t\t\t\t\t\t\t<ul class=\"nav nav-second-level\">
\t\t\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
        // line 226
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reservation_hotel_admin_list");
        echo "\"><i class=\"fa fa-circle-o-notch\" aria-hidden=\"true\"></i>Hotels </a>
\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
        // line 229
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reservation_programme_list_admin");
        echo "\"><i class=\"fa fa-circle-o-notch\" aria-hidden=\"true\"></i>Programmes </a>
\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
        // line 232
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reservation_restaurant_list_admin");
        echo "\"><i class=\"fa fa-circle-o-notch\" aria-hidden=\"true\"></i>Restaurants </a>
\t\t\t\t\t\t\t\t\t\t\t</li>\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"{{ url('app_civilisation_index_back') }}\"><i class=\"fa fa-circle-o-notch\" aria-hidden=\"true\"></i>Manage Civilisations</a>
\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"{{ url('app_programe_index_back') }}\"><i class=\"fa fa-circle-o-notch\" aria-hidden=\"true\"></i>Manage programes</a>
\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t   <li>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"manage-destinations.html\"><i class=\"fa fa-circle-o-notch\" aria-hidden=\"true\"></i>Manage Destinations</a>
\t\t\t\t\t\t\t\t\t\t\t</li>
...
\t\t\t\t\t\t\t\t\t\t<ul class=\"nav nav-second-level\">
\t\t\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"{{ path('app_reservation_hotel_admin_list') }}\"><i class=\"fa fa-circle-o-notch\" aria-hidden=\"true\"></i>Hotels </a>
\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"{{ path('app_reservation_programme_list_admin') }}\"><i class=\"fa fa-circle-o-notch\" aria-hidden=\"true\"></i>Programmes </a>
\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t<li>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"{{ path('app_reservation_restaurant_list_admin') }}\"><i class=\"fa fa-circle-o-notch\" aria-hidden=\"true\"></i>Restaurants </a>
\t\t\t\t\t\t\t\t\t\t\t</li>\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t
