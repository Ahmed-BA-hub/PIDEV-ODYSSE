...
class __TwigTemplate_50811ad214de9c7a8713e502db941228 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["reservation_hotel"]) {
            ...
            echo "\">edit</a>
               <a href=\"";
            // line 28
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_reclamation_new", ["idprogramme" => 0, "idrestaurant" => 0, "idhotel" => twig_get_attribute($this->env, $this->source, $context["reservation_hotel"], "id", [], "any", false, false, false, 28)]), "html", null, true);
            echo "\">Reclamer</a>
                 </td>
            </tr>
        ";
    ...
    <table class=\"table\">
        ...
        {% for reservation_hotel in reservation_hotels %}
            <tr>
               ...
               <a href=\"{{ path('app_reclamation_new', {'idprogramme': 0,'idrestaurant':0,'idhotel':reservation_hotel.id}) }}\">Reclamer</a>
                 </td>
            </tr>
        {% else %}
            <tr>
...
{% endblock %}
", "reservation_hotel/index.html.twig", "C:\\Users\\Racha\\Documents\\GitHub\\PIDEV-ODYSSE\\templates\\reservation_hotel\\index.html.twig");
    }
}
